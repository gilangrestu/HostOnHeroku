        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
            <form>
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="">
                        <input type="hidden" wire:model="mobilid">
                        ...
                        <div class="mb-4">
                            <label for="tglpinjamdari" class="block text-gray-700 text-sm font-bold mb-2">Tanggal Peminjaman Dari:</label>
                            <input type="date" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="TglPinjam" wire:model="tglpinjamdari">
                            @error('tglpinjamdari') <span class="text-red-500">{{ $message }}</span>@enderror
                        </div>
                        <div class="mb-4">
                            <label for="tglpinjamsampai" class="block text-gray-700 text-sm font-bold mb-2">Tanggal Peminjaman Sampai:</label>
                            <input type="date" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="TglPinjam" wire:model="tglpinjamsampai">
                            @error('tglpinjamsampai') <span class="text-red-500">{{ $message }}</span>@enderror
                        </div>
                        <div class="mb-4">
